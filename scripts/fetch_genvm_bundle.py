...
a machine with a cold cache â€” a CI runner, a fresh clone â€” fetching it
...
absent or complete â€” never half-written.
...
# contracts/credencelend.py's `Depends` header; "whatever is latest" is not a
...
# Newest name first â€” the old one is kept so an older pin still resolves.
    ...
    for asset in ASSETS:
        ...
        try:
            request = urllib.request.Request(
                url, headers={"User-Agent": "credencelend-ci"})
